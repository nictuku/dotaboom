...
// source: dota/dota_gcmessages_server.proto
// DO NOT EDIT!

/*
Package dota_gcmessages_server is a generated protocol buffer package.
...
*/
package dota_gcmessages_server
...
import econ_gcmessages "econ_gcmessages.pb"
import network_connection "network_connection.pb"
...
type CMsgPoorNetworkConditions_Player struct {
	...
	DisconnectReason *network_connection.ENetworkDisconnectionReason `protobuf:"varint,2,opt,name=disconnect_reason,enum=ENetworkDisconnectionReason,def=0" json:"disconnect_reason,omitempty"`
...
const Default_CMsgPoorNetworkConditions_Player_DisconnectReason network_connection.ENetworkDisconnectionReason = network_connection.ENetworkDisconnectionReason_NETWORK_DISCONNECT_INVALID
...
func (m *CMsgPoorNetworkConditions_Player) GetDisconnectReason() network_connection.ENetworkDisconnectionReason {
...
type CMsgConnectedPlayers struct {
	...
	GameState             *dota_gcmessages_common.DOTA_GameState `protobuf:"varint,2,opt,name=game_state,enum=DOTA_GameState,def=0" json:"game_state,omitempty"`
...
const Default_CMsgConnectedPlayers_GameState dota_gcmessages_common.DOTA_GameState = dota_gcmessages_common.DOTA_GameState_DOTA_GAMERULES_STATE_INIT
...
func (m *CMsgConnectedPlayers) GetGameState() dota_gcmessages_common.DOTA_GameState {
...
type CMsgConnectedPlayers_Player struct {
	...
	LeaverState      *dota_gcmessages_common.CMsgLeaverState         `protobuf:"bytes,3,opt,name=leaver_state" json:"leaver_state,omitempty"`
	DisconnectReason *network_connection.ENetworkDisconnectionReason `protobuf:"varint,4,opt,name=disconnect_reason,enum=ENetworkDisconnectionReason,def=0" json:"disconnect_reason,omitempty"`
	XXX_unrecognized []byte                                          `json:"-"`
}
...
const Default_CMsgConnectedPlayers_Player_DisconnectReason network_connection.ENetworkDisconnectionReason = network_connection.ENetworkDisconnectionReason_NETWORK_DISCONNECT_INVALID
...
func (m *CMsgConnectedPlayers_Player) GetLeaverState() *dota_gcmessages_common.CMsgLeaverState {
	if m != nil {
...
func (m *CMsgConnectedPlayers_Player) GetDisconnectReason() network_connection.ENetworkDisconnectionReason {
	if m != nil && m.DisconnectReason != nil {
		return *m.DisconnectReason
	}
...
type CMsgLeaverDetected struct {
	SteamId               *uint64                                         `protobuf:"fixed64,1,opt,name=steam_id" json:"steam_id,omitempty"`
	LeaverStatus          *dota_gcmessages_common.DOTALeaverStatusT       `protobuf:"varint,2,opt,name=leaver_status,enum=DOTALeaverStatusT,def=0" json:"leaver_status,omitempty"`
	LeaverState           *dota_gcmessages_common.CMsgLeaverState         `protobuf:"bytes,4,opt,name=leaver_state" json:"leaver_state,omitempty"`
	ServerCluster         *uint32                                         `protobuf:"varint,5,opt,name=server_cluster" json:"server_cluster,omitempty"`
	DisconnectReason      *network_connection.ENetworkDisconnectionReason `protobuf:"varint,6,opt,name=disconnect_reason,enum=ENetworkDisconnectionReason,def=0" json:"disconnect_reason,omitempty"`
...
const Default_CMsgLeaverDetected_LeaverStatus dota_gcmessages_common.DOTALeaverStatusT = dota_gcmessages_common.DOTALeaverStatusT_DOTA_LEAVER_NONE
const Default_CMsgLeaverDetected_DisconnectReason network_connection.ENetworkDisconnectionReason = network_connection.ENetworkDisconnectionReason_NETWORK_DISCONNECT_INVALID
...
func (m *CMsgLeaverDetected) GetLeaverStatus() dota_gcmessages_common.DOTALeaverStatusT {
...
func (m *CMsgLeaverDetected) GetLeaverState() *dota_gcmessages_common.CMsgLeaverState {
	if m != nil {
		return m.LeaverState
	}
	return nil
...
func (m *CMsgLeaverDetected) GetDisconnectReason() network_connection.ENetworkDisconnectionReason {
	if m != nil && m.DisconnectReason != nil {
		return *m.DisconnectReason
	}
...
type CMsgGameMatchSignOut struct {
	...
	PicksBans                     []*dota_gcmessages_common.CMatchHeroSelectEvent         `protobuf:"bytes,15,rep,name=picks_bans" json:"picks_bans,omitempty"`
...
func (m *CMsgGameMatchSignOut) GetPicksBans() []*dota_gcmessages_common.CMatchHeroSelectEvent {
	if m != nil {
		return m.PicksBans
	}
	return nil
...
type CMsgGameMatchSignOut_CTeam_CPlayer struct {
	...
	AbilityUpgrades          []*dota_gcmessages_common.CMatchPlayerAbilityUpgrade    `protobuf:"bytes,32,rep,name=ability_upgrades" json:"ability_upgrades,omitempty"`
	AdditionalUnitsInventory []*dota_gcmessages_common.CMatchAdditionalUnitInventory `protobuf:"bytes,33,rep,name=additional_units_inventory" json:"additional_units_inventory,omitempty"`
...
func (m *CMsgGameMatchSignOut_CTeam_CPlayer) GetAbilityUpgrades() []*dota_gcmessages_common.CMatchPlayerAbilityUpgrade {
	if m != nil {
...
func (m *CMsgGameMatchSignOut_CTeam_CPlayer) GetAdditionalUnitsInventory() []*dota_gcmessages_common.CMatchAdditionalUnitInventory {
	if m != nil {
...
type CMsgSignOutDraftInfo struct {
	...
	PicksBans               []*dota_gcmessages_common.CMatchHeroSelectEvent `protobuf:"bytes,3,rep,name=picks_bans" json:"picks_bans,omitempty"`
	XXX_unrecognized        []byte                                          `json:"-"`
}
...
func (m *CMsgSignOutDraftInfo) GetPicksBans() []*dota_gcmessages_common.CMatchHeroSelectEvent {
	if m != nil {
		return m.PicksBans
	}
	return nil
...
type CMsgSignOutBotInfo struct {
	...
	BotDifficulty       *dota_gcmessages_common.DOTABotDifficulty   `protobuf:"varint,2,opt,name=bot_difficulty,enum=DOTABotDifficulty,def=0" json:"bot_difficulty,omitempty"`
...
const Default_CMsgSignOutBotInfo_BotDifficulty dota_gcmessages_common.DOTABotDifficulty = dota_gcmessages_common.DOTABotDifficulty_BOT_DIFFICULTY_PASSIVE
...
func (m *CMsgSignOutBotInfo) GetBotDifficulty() dota_gcmessages_common.DOTABotDifficulty {
...
const Default_CMsgSignOutBotInfo_CMsgBotSlotDifficulty_BotDifficulty dota_gcmessages_common.DOTABotDifficulty = dota_gcmessages_common.DOTABotDifficulty_BOT_DIFFICULTY_PASSIVE
...
func (m *CMsgSignOutBotInfo_CMsgBotSlotDifficulty) GetBotDifficulty() dota_gcmessages_common.DOTABotDifficulty {
	if m != nil && m.BotDifficulty != nil {
		return *m.BotDifficulty
	}
...
type CMsgGameMatchSignoutResponse struct {
	...
	TimedRewardDetails []*dota_gcmessages_common.CLobbyTimedRewardDetails    `protobuf:"bytes,3,rep,name=timed_reward_details" json:"timed_reward_details,omitempty"`
	XpRewardDetails    []*dota_gcmessages_common.CDOTALobbyMember            `protobuf:"bytes,4,rep,name=xp_reward_details" json:"xp_reward_details,omitempty"`
...
func (m *CMsgGameMatchSignoutResponse) GetTimedRewardDetails() []*dota_gcmessages_common.CLobbyTimedRewardDetails {
	if m != nil {
...
func (m *CMsgGameMatchSignoutResponse) GetXpRewardDetails() []*dota_gcmessages_common.CDOTALobbyMember {
	if m != nil {
...
type CMsgTournamentItemEvent struct {
	...
	EventType        *dota_gcmessages_common.DOTA_TournamentEvents `protobuf:"varint,3,opt,name=event_type,enum=DOTA_TournamentEvents,def=0" json:"event_type,omitempty"`
...
const Default_CMsgTournamentItemEvent_EventType dota_gcmessages_common.DOTA_TournamentEvents = dota_gcmessages_common.DOTA_TournamentEvents_TE_FIRST_BLOOD
...
func (m *CMsgTournamentItemEvent) GetEventType() dota_gcmessages_common.DOTA_TournamentEvents {
...
type CMsgTournamentItemEventResponse struct {
	EventType        *dota_gcmessages_common.DOTA_TournamentEvents `protobuf:"varint,1,opt,name=event_type,enum=DOTA_TournamentEvents,def=0" json:"event_type,omitempty"`
...
const Default_CMsgTournamentItemEventResponse_EventType dota_gcmessages_common.DOTA_TournamentEvents = dota_gcmessages_common.DOTA_TournamentEvents_TE_FIRST_BLOOD

func (m *CMsgTournamentItemEventResponse) GetEventType() dota_gcmessages_common.DOTA_TournamentEvents {
	if m != nil && m.EventType != nil {
		return *m.EventType
	}
...
type CSerializedCombatLog struct {
	...
	Entries          []*dota_gcmessages_common.CMsgDOTACombatLogEntry `protobuf:"bytes,3,rep,name=entries" json:"entries,omitempty"`
	XXX_unrecognized []byte                                           `json:"-"`
}
...
func (m *CSerializedCombatLog) GetEntries() []*dota_gcmessages_common.CMsgDOTACombatLogEntry {
	if m != nil {
		return m.Entries
	}
	return nil
...
type CMsgServerToGCGetAdditionalEquipsResponse_CUserEquips struct {
	AccountId        *uint32                                        `protobuf:"varint,1,opt,name=account_id" json:"account_id,omitempty"`
	Equips           []*dota_gcmessages_common.CAdditionalEquipSlot `protobuf:"bytes,2,rep,name=equips" json:"equips,omitempty"`
	XXX_unrecognized []byte                                         `json:"-"`
}
...
func (m *CMsgServerToGCGetAdditionalEquipsResponse_CUserEquips) GetEquips() []*dota_gcmessages_common.CAdditionalEquipSlot {
	if m != nil {
		return m.Equips
	}
	return nil
...
type CMsgServerToGCGetProfileCardResponse struct {
	Cards            []*dota_gcmessages_common.CMsgDOTAProfileCard `protobuf:"bytes,1,rep,name=cards" json:"cards,omitempty"`
	XXX_unrecognized []byte                                        `json:"-"`
}
...
func (m *CMsgServerToGCGetProfileCardResponse) GetCards() []*dota_gcmessages_common.CMsgDOTAProfileCard {
	if m != nil {
		return m.Cards
	}
	return nil
...
type CMsgServerToGCGetIngameEventData struct {
	Event            *dota_gcmessages_common.EIngameEvent `protobuf:"varint,1,opt,name=event,enum=EIngameEvent,def=0" json:"event,omitempty"`
	XXX_unrecognized []byte                               `json:"-"`
}
...
const Default_CMsgServerToGCGetIngameEventData_Event dota_gcmessages_common.EIngameEvent = dota_gcmessages_common.EIngameEvent_k_EIngameEvent_OraclePA

func (m *CMsgServerToGCGetIngameEventData) GetEvent() dota_gcmessages_common.EIngameEvent {
